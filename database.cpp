...
void Database::showdbinfo() {
  ...
  QString fileName = "/Volumes/HEAT_SUKO/HEAT/TIR_DATA_original" +
  ...
  if (query.value(0).toString().length() != 23 ||
    ...
    if (bl == true && bl2 == true && bl3 == true) {
      fileName = "/Volumes/HEAT_SUKO/HEAT/TIR_DATA_original" +
...
void Database::on_subPair_clicked() {
  ...
  file1 = "/Volumes/HEAT_SUKO/HEAT/TIR_DATA_original/" +
          query.value(2).toString() + "/" + query.value(0).toString();
  file2 = "/Volumes/HEAT_SUKO/HEAT/TIR_DATA_original/" +
